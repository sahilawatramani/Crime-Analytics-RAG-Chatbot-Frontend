...
(async () => {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        chatForm.addEventListener('submit', async (event) => {
            ...
            try {
                const result = await gr_query(query);
                let mainText = '';
        ...
        async function loadQuickStats() {
            try {
                const stats = await gr_quick_stats();
        ...
        async function loadFilters() {
            try {
                const filterOptions = await gr_filter_options();
        ...
        async function loadSampleQueries() {
            try {
                const categories = await gr_sample_queries();
